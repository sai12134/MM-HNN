...
def smi2hgraph(smiles_string, delocalization=None):
    """
...
if __name__ == '__main__':
    # test code
    atom_fvs, n_idx, e_idx, bond_fvs = smi2hgraph('O=C1C(O)=C(C2CCC(C3:C:C:C(Cl):C:C:3)CC2)C(=O)C2:C:C:C:C:C:21', True)
    pass
